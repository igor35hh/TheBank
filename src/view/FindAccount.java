...
import controller.ControllerFindAccount;
import controller.ControllerKeyAdapter;

public class FindAccount extends JInternalFrame {
	...
	public FindAccount() {
		...
		ControllerFindAccount controllerFindAccount = new ControllerFindAccount(this);
		
		btnFind = new JButton ("Search");
		btnFind.setBounds (20, 165, 120, 25);
		btnFind.addActionListener (controllerFindAccount);
		
		btnCancel = new JButton ("Cancel");
		btnCancel.setBounds (200, 165, 120, 25);
		btnCancel.addActionListener (controllerFindAccount);
		...
		controllerFindAccount.populateArray ();
